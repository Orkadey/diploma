...
Intel VT-x и AMD-V можно рассматривать как функции центрального процессора, которые перехватывают особые инструкции, могущие повлиять на корректную работу гипервизора, т. н. sensitive-инструкций (англ. sensitive instructions) и передают управление гипервизору. Существует два типа таких инструкций:
