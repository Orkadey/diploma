...
>Переключение режимов выполнения инструкций, поддерживаемое технологиями аппаратной виртуализации
...
Последовательность выполнения QEMU/KVM показана на **рисунке ХХХ** __[Комментарий к рисунку: переименовать "Ядро Linux (гипервизор)" в "Пространство ядра"]__. 
...
>алгоритм оптимизации работы гипервизора с использованием KVM
...
> Общая архитектура платформы виртуализации QEMU/KVM
...
>нарисую картинку (навзвание: пример структуры памяти)
