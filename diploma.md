...
Данные условия порождают идею оптимизации работы гипервизора. Разработка KVM была основана на реализации этой концепции, при этом преследовалась цель внесения минимальных изменений в существующий монитор виртуальных машин при максимальном использовании его возможностей.

Последовательность выполнения QEMU/KVM показана на **рисунке ХХХ** __[Осбудить комментарий к рисунку]__. 
